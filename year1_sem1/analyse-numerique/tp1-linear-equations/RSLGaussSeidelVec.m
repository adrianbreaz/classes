function [x0, it] = RSLGaussSeidelVec(A, b, x0, tol, maxIt)
    % Description:
    %   Solve the system of equations A * x = b using the Gauss-Seidel method. (vectorial variant)
    % Arguments:
    %   A       (M_(n, n))      - matrix.
    %   b       (R^n)           - vector.
    ...
    % Usage:
    %   [x, iterations] = RSLGaussSeidelVec(A, b[, x0[, tol[, maxIt]]])
    %
